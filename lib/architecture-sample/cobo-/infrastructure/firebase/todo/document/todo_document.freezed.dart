...
abstract class $TodoDocumentCopyWith<$Res> {
  ...
  @useResult
  $Res call({String description, @TimestampConverter() DateTime? createdAt});
}
...
class _$_TodoDocument extends _TodoDocument {
  const _$_TodoDocument(
      {this.description = '', @TimestampConverter() this.createdAt})
      : super._();
  ...
  @override
  String toString() {
    return 'TodoDocument(description: $description, createdAt: $createdAt)';
  }
